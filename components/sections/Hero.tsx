...
export default function Hero() {
  return (
    <section>
        ...
        {/* left side */}
        <div className='flex flex-col justify-end sm:flex-1 mt-1'>
          <div><Badge className=' bg-sky-100 text-blue-700 rounded-md w-28 px-4 py-2 h-10 font-semibold mb-6 text-md'>Sale 70%</Badge></div>
          <div><h1 className="text-4xl font-bold tracking-normal lg:text-6xl max-w-md">
          An Industrial Take on Streetwear
          </h1></div>
          <p className="leading-7 mt-6 max-w-[300px] tracking-normal font-semibold text-gray-600 text-md">
...
{/* right side */}
        ...
        <Button className='flex h-16 w-32 mt-6 border-[4px] border-slate-800 border-spacing-1'>
