  ...
  return (
    <section>
        <Wraper>
            ...
            <div className="flex justify-center items-center cursor-pointer lg:hidden md:hidden"
             onClick={()=> setNav(!nav)}>
            ...
            {/* mobile screen */}
            <div className=" fixed left-0 top-0 h-screen w-full py-6 flex items-center justify-center">
